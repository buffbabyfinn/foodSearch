...
menu-items:[
  ...
  ,{dish-name: "Creme Brulee French Toast", description: "", ingredients: ["brioche"], glutenfree: false, vegetarian: true, pescetarian: true, vegan: false, dairy-free: false, nut-allergy: true, hindu: false, jewish: true, muslim: true, price: "9.00", picture: true}

  ,{dish-name: "Tofu Hash", description: "", ingredients: ["eggs","tofu","potatoes","seasonal vegetables","toast"], glutenfree: false, vegetarian: true, pescetarian: true, vegan: false, dairy-free: false, nut-allergy: true, hindu: false, jewish: true, muslim: true, price: "11.00", picture: true}

  ,{dish-name: "Veggie Sausage Scramble", description: "", ingredients: ["vegan sausage","eggs","cheddar","greens","tomato confit"], glutenfree: false, vegetarian: true, pescetarian: true, vegan: false, dairy-free: false, nut-allergy: true, hindu: false, jewish: true, muslim: true, price: "11.00", picture: true}

  ,{dish-name: "Oregon Salad", description: "", ingredients: ["greens", "beets","pear","hazelnut","chevre","sherry vinaigrette"], glutenfree: true, vegetarian: true, pescetarian: true, vegan: false, dairy-free: false, nut-allergy: false, hindu: false, jewish: true, muslim: false, price: "13.00", picture: true}
