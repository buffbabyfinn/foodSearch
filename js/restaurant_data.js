...
var R7 = new Restaurant("Maurice", "maurice", ["french","nordic"], ["lunch"], 4, 3, "45.522952, -122.680460",  ['glutenFree','vegetarian','pescatarian','vegan','dairyFree','hindu','kosher','halal','nutAllergy'], []);

//Ox Restaurant Object
var R8 = new Restaurant ("Ox", "ox", ["argentinian"], ["dinner"], 4, 3, "45.539649, -122.661932", ['glutenFree','vegetarian','pescatarian','vegan','dairyFree','hindu','kosher','halal','nutAllergy'])

//Le Pigeon Restaurant Object
var R9 = new Restaurant ("Le Pigeon",  "lePigeon", ["french"], ["dinner"], 5, 3, "45.522963, -122.658022", ['glutenFree','vegetarian','pescatarian','dairyFree','hindu','kosher','halal','nutAllergy'], []);

//Ava Gene's Restaurant Object
var R10 = new Restaurant ("Ava Gene's", "avaGenes", ["italian"], ["dinner"], 4, 3, "45.505231, -122.629935", ['glutenFree','vegetarian','pescatarian','vegan','dairyFree','hindu','kosher','halal','nutAllergy'], []);

//Paadee Restaurant Object
var R11 = new Restaurant ("Paadee", "paadee", ["thai"], ["lunch","dinner"],  3, 2, "45.523382, -122.637048", ['glutenFree','vegetarian','pescatarian','vegan','dairyFree','hindu','kosher','halal','nutAllergy'], []);
